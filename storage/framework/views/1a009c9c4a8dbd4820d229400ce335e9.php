...
<body>
    ...
    <main>
        ...
        <div class="mainContainer">
            <div class="sideNav">
                    <a href="<?php echo e(route('account.orders')); ?>" class="sideNavLink active">
                        ...
                        <div style="border: 1px solid #ccc; padding: 15px; margin: 20px 0; border-radius: 5px;">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    ...
                                    <p>Status: <strong style="color: <?php echo e($order->order_status == 'Pending' ? 'orange' : 'blue'); ?>"><?php echo e($order->order_status); ?></strong></p>
                                </div>
...
<?php /**PATH /var/www/html/resources/views/account/orders.blade.php ENDPATH**/ ?>