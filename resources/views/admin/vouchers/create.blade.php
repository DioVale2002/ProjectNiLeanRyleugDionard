...
<div class="font-sans">
    ...
    {{-- FIXED: Form wraps everything so all inputs are submitted properly --}}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="voucherName" value="{{ old('voucherName') }}" placeholder="e.g. SUMMER2024" class="w-full h-11 rounded-lg border border-gray-300 px-4 focus:outline-none focus:border-[#FCAE42] focus:ring-1 focus:ring-[#FCAE42] transition-colors" required />
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <select name="voucherType" class="w-full h-11 appearance-none rounded-lg border border-gray-300 px-4 focus:outline-none focus:border-[#FCAE42] focus:ring-1 focus:ring-[#FCAE42] transition-colors bg-white" required>
                                ...
                                <option value="flat" {{ old('voucherType') === 'flat' ? 'selected' : '' }}>Flat Amount (₱)</option>
                            </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="voucherAmount" step="0.01" min="0" value="{{ old('voucherAmount') }}" placeholder="0.00" class="w-full h-11 rounded-lg border border-gray-300 px-4 focus:outline-none focus:border-[#FCAE42] focus:ring-1 focus:ring-[#FCAE42] transition-colors" required />
                    </div>
                </div>

                <button type="submit" class="w-full py-3.5 rounded-xl bg-[#F54E4E] hover:bg-red-600 transition-colors text-white font-bold text-lg shadow-sm flex justify-center items-center gap-2 mt-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                ...
                <div>
                    ...
                    <textarea name="voucherDetails" class="w-full h-[200px] rounded-lg border border-gray-300 p-4 focus:outline-none focus:border-[#FCAE42] focus:ring-1 focus:ring-[#FCAE42] transition-colors resize-none" placeholder="Add any internal notes, terms, or conditions for this voucher here.">{{ old('voucherDetails') }}</textarea>
                </div>
            </div>
