...
<body class="">
    <div class="flex items-center justify-between px-[261px]">
        <a href="/"><img src="{{ asset('assets/Logo.png') }}" alt="Character portrait" class="" /></a>
        <div class="relative">
            <input
                type="text"
                placeholder="Search"
    ...
    <div class="flex mx-[282px] mb-[80px]">
        <div class="w-[342px]">
            ...
            <a class="flex items-center hover:bg-[#ED1B24]/30 p-1.5 rounded-md mb-[17px] {{ request()->routeIs('account.archived') ? 'bg-[#ED1B24]/30' : '' }}" href="{{ route('account.archived') }}">
                <div class="w-[70px] bg-white rounded-sm border border-black/30">
        ...
        <div class="border border-black/50 rounded-lg ml-[63px] w-[1000px] h-full">
            <div class="mx-7 mt-7 pb-7">
                ...
                <div class="text-center py-10">
                    <h3 class="text-red-500 font-bold text-2xl">No Orders yet.</h3>
                </div>
                @else
                ...
                <div class="mb-12 border-b border-gray-300 pb-8 last:border-b-0">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="space-y-1">
                            <p class="font-bold {{ $order->order_status == 'Completed' ? 'text-[#44e635]' : ($order->order_status == 'Cancelled' ? 'text-red-500' : 'text-gray-500') }}">
                                {{ $order->order_status }}
                            </p>
                    ...
                    <div class="mt-12 grid grid-cols-2 gap-4">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-4 flex flex-col justify-center">
                                <p class="font-semibold line-clamp-2">{{ $item->product->Title }}</p>
                                <p class="mt-2 text-gray-600">Quantity: {{ $item->quantity }}</p>
                                <p class="font-bold text-gray-800">Total Price: ₱{{ number_format($item->subtotal, 2) }}</p>
                            </div>
                        </div>
                        @endforeach
                    </div>
